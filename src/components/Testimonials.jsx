...
const Testimonials = () => {
  ...
  return (
    <div className="relative w-full h-[600px] md:h-[550px] overflow-hidden p-8 pt-20 bg-black">
      ...
      >
        {slides.map((slide, idx) => (
          <div
            key={idx}
            className="flex w-full h-full flex-shrink-0 p-4 md:p-36 items-center justify-center bg-black"
          >
